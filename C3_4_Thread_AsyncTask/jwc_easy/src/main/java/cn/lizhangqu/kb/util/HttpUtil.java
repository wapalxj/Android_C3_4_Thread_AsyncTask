...
public class HttpUtil {
	...
	// Host地址
	public static final String HOST = "此处改成对应的地址";
	// 基础地址
	public static final String URL_BASE = "http://此处改成对应的地址/";
	// 验证码地址
	public static final String URL_CODE = "http://此处改成对应的地址/CheckCode.aspx";
	// 登陆地址
	public static final String URL_LOGIN = "http://此处改成对应的地址/default2.aspx";
	// 登录成功的首页
	public static String URL_MAIN = "http://此处改成对应的地址/xs_main.aspx?xh=XH";
	// 请求地址
	public static String URL_QUERY = "http://此处改成对应的地址/QUERY";
